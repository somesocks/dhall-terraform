{ Type =
    ...
    , spec :
        List
          { concurrency_policy : Optional Text
          , failed_jobs_history_limit : Optional Natural
          , schedule : Text
          , starting_deadline_seconds : Optional Natural
          , successful_jobs_history_limit : Optional Natural
