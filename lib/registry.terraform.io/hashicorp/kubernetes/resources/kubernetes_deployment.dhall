{ Type =
    ...
    , spec :
        List
          { min_ready_seconds : Optional Natural
          , paused : Optional Bool
          , progress_deadline_seconds : Optional Natural
          , replicas : Optional Text
          , revision_history_limit : Optional Natural
          , selector :
              Optional
                ( List
                    { match_labels :
              ...
              List
                ...
                , spec :
                    List
                          ...
                          Optional
                            ( List
                                ...
                                , option :
                                    Optional
                                      ( List
                                          { name : Text, value : Optional Text }
                                      )
                                }
                            )
                      , host_aliases :
                          Optional (List { hostnames : List Text, ip : Text })
                      ...
                      , readiness_gate :
                          Optional (List { condition_type : Text })
                      , security_context :
                          Optional
                            ( List
                      ...
                      , volume :
                          Optional
                            ( List
                                ...
                                , local :
                                    Optional (List { path : Optional Text })
                                , nfs :
                                    Optional
                                      ( List
                                          { path : Text
