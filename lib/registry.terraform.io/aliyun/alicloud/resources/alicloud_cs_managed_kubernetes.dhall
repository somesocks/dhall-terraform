{ Type =
    ...
    , encryption_provider_key : Optional Text
    ...
    , worker_instance_types : Optional (List Text)
    , worker_nodes :
        Optional (List { id : Text, name : Text, private_ip : Text })
    , worker_number : Optional Natural
...
, default =
  ...
  , encryption_provider_key = None Text
  ...
  , worker_instance_types = None (List Text)
  , worker_nodes = None (List { id : Text, name : Text, private_ip : Text })
  , worker_number = None Natural
